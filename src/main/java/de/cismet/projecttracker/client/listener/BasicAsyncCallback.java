...
public class BasicAsyncCallback<E> implements AsyncCallback<E> {
    ...
    /**
     * This method will be invoked after the response of an async call was
     * received. You should override this method instead of the methods
     * onFailure and onSuccess in order to react on the success or failure of an
     * async server call.
     *
     * @param result the result of the call
     * @param operationFailed true, if the call was successfully, false
     * otherwise
     */
